...
<div class="container content">
    ...
    <legend><h1>Editar Semi-Nova</h1></legend>
    ...
    <form id="seminova_form" class="form-horizontal" action="../operacoes/CSemi/editar_seminova_op.php" method="post" enctype="multipart/form-data" name="cadastro" >  
        ...
        <div class="control-group input-warming">
            ...
            <div class="controls">
                <input class="input-large input-warming" type="text" value="<?php print $fetch->modelo; ?>" name="modelo" id="input-modelo" placeholder="Ex: CBR 600">
            </div>
        </div>
        ...
        <div class="control-group input-warming">
            ...
            <div class="controls">
                <input class="input-large" type="text" name="marca" value="<?php print $fetch->marca; ?>" id="input-marca" placeholder="Ex: Honda">
            </div>
        </div>        
        ...
        <div class="control-group input-warming">
            ...
            <div class="controls">
                <input class="input-small" type="text" name="ano" id="input-ano" placeholder="Ex: 200" value="<?php print $fetch->ano; ?>">
            </div>
        </div>
        ...
        <div class="control-group input-warming">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input class="span2" id="prependedInput" type="text"name="preco" id="input-preco" placeholder="Ex: 3000,00" value="<?php print $preco; ?>">
        ...
        <div class="control-group input-warming">
            ...
            <div class="controls">
                <input class="input-small" type="text" name="potencia" id="input-potencia" placeholder="Ex: 100" value="<?php print $fetch->potencia; ?>">
            </div>
        </div>
        ...
        <div class="control-group input-warming">
            ...
            <div class="controls">
                <input class="input-small" type="text" name="cilindrada" id="input-cilindrada" placeholder="Ex: 600"  value="<?php print $fetch->cilindradas; ?>">
            </div>
        </div>
        ...
        <div class="control-group input-warming">
            ...
            <div class="controls">
                <input class="input-small" type="text" name="km" id="input-km" placeholder="Ex: 5000"  value="<?php print $fetch->km; ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-small" type="text" name="refrigeracao" id="input-refrigeracao" placeholder="Ex: Ar"  value="<?php print $fetch->refrigeracao; ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-small" type="text" name="motor" id="input-motor" placeholder="Ex: 4 tempos"  value="<?php print $fetch->motor; ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-small" type="text" name="cor" id="input-cor" placeholder="Ex: Amarelo"  value="<?php print $fetch->cor; ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <button type="button" class="btn btn-primary"  data-toggle="modal" href="#modal_img_upload_post">Gerenciar Imagens</button>
            </div>
        </div>
        ...
        <div id="modal_img_upload_post" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="img_produto_container">
                    ...
                    <button id="foto_miniatura" type="button" class="btn btn-danger btn-mini remove_img"><i class="icon-remove"></i></button>
                </div>
