...
<form id="seminova_form" class="form-horizontal" action="../operacoes/CSemi/incluir_seminova.php" method="post"
...
<div class="control-group input-warming">
    ...
    <div class="controls">
        <div class="input-prepend">
            ...
            <input class="span2" id="prependedInput" type="text" name="preco" id="input-preco"
...
<div class="control-group">
    ...
    <div class="controls">
        <button type="button" class="btn btn-primary" data-toggle="modal" href="#modal_img_upload_post">+ Adicionar
            Imagens ao Anúncio
        </button>
