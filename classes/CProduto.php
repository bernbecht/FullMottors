...
class CProduto
{
                                ...
                                $parcelas, $prazo)
    {
        ...
        $this->view_status = CUtils::postgresBooleanTranslater($view_status);
        $this->lancamento = CUtils::postgresBooleanTranslater($lancamento);
        $this->preco = $preco;
    ...
    public function setImgCover($img_cover_object){
        $this->img_cover = $img_cover_object;
    }
