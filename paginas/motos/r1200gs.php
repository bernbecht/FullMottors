...
<html>
    ...
    <head>
        <title>
            BMW R 1200 GS - Full Mottors
        </title>

        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta property="og:title" content=" BMW R 1200 GS - Full Mottors">


        <meta name="description" content="Confira a BMW R 1200 GS 0 Km na Full Mottors - Multimarcas"/>
        ...
        <div class="wrapper">
            <div class="titulo_pagina">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">BMW R 1200 GS</li>
                </ul>
            ...
            <div class="moto_desc-galeria">
                <div class="moto_desc-thumbMain">
                    <a href="javascript:;"><img src="../../img/motos-desc/R1200GS/R1200GS3.jpg" /></a>
                </div>
                <div class="moto_desc-thumb">
                    <ul>
                        ...
                        <li><a href="javascript:;"><img src="../../img/motos-desc/R1200GS/R1200GS4_thumb.jpg" /></a></li>
            ...
            <div class="moto_dados">
                ...
                <div class="descricao">
                    ...
                    <p>Para muitas pessoas, é uma motocicleta 
                        incrivelmente concebida - seja para trechos urbanos, 
                        nos caminhos diários para o trabalho ou em viagens de 
                        final de semana com ou sem passagens por cascalhos. 
                        Para outros é um estilo de vida - apenas a máquina 
                        certa para cada trajeto, seja para viagem de uma semana 
                        acompanhado, no território local ou a realização do 
                        sonho de milhares de quilômetros longe de casa.</p>
                </div>
                <div class="clear"></div>
            </div>
        </div>
