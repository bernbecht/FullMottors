...
<html>
    ...
    <head>
        <title>
            BMW K 1600 GT - Full Mottors
        </title>

        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta property="og:title" content=" BMW K 1600 GT - Full Mottors">


        <meta name="description" content="Confira a BMW K 1600 GT 0 Km na Full Mottors - Multimarcas"/>
        <meta name="og:description" content="Confira a BMW K 1600 GT 0 Km na Full Mottors - Multimarcas"/>
        ...
        <div class="wrapper">
            <div class="titulo_pagina">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">BMW K 1600 GT</li>
                </ul>
            ...
            <div class="moto_dados">
                ...
                <div class="descricao">
                    ...
                    <p>Quando o luxo está livre de todo lastro, se move a um 
                        novo estágio. No topo dessa evolução esta a nova 
                        BMW K 1600 GTL – uma motocicleta de turismo de alta 
                        classe como nenhuma já vista. Com o mais compacto e 
                        eficiente motor de 6 cilindros já instalado em
                        motocicletas de produção em série.</p>
                </div>
                <div class="clear"></div>
            </div>
        </div>
